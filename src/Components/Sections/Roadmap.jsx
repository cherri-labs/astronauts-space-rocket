    ...
    <div className="section page" id="roadmap">
          ...
          <div className="text">
            <div className="map">
              <div id="map-section-world"
                    ...
                    <div className="card-wrap">
                      <div className="card">
                        ...
                        <p>
                          ...
                          that is, we will try our best to get the path down in a clear
                          and linear way for you to travel upon.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <article>
                  <div className="slide" data-anchor="the-way-things-were">
                    <div className="card-wrap">
                      <div className="card">
                ...
                <article>
                  <div className="slide" data-anchor="the-future">
                    <div className="card-wrap">
                      <div className="card">
                        <h3>The Future</h3>
                        <p>
              ...
              <div id="map-section-vision"
                ...
                <article>
                  <div className="slide" data-anchor="vision">
                    <div className="card-wrap">
                      <div className="card">
                        <h3>Changes</h3>
                        <p>
                ...
                <article>
                  <div className="slide" data-anchor="minimalism">
                    <div className="card-wrap">
                      <div className="card">
                        <h3>Minimalism</h3>
                        <p>
     ...
     is always in clear sight.</b>
            ...
            Commanders</strong> will be airdropped to holders and giveaway
                ...
                <article>
                  <div className="slide" data-anchor="expansion">
                    <div className="card-wrap">
                      <div className="card locked">
                        <h3>Expansion</h3>
                        <p>
                ...
                <article>
                  <div className="slide" data-anchor="quest-to-faraway">
                    <div className="card-wrap">
                      <div className="card locked">
